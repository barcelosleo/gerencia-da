...
urlpatterns = [
    ...
    path('links-cadastro/', views.LinkCadastroListView.as_view(), name="gestao-links-cadastro"),
    path('link-cadastro/', views.CriarLinkCadastroView.as_view(), name="gestao-links-cadastro-novo"),
    path('link-cadastro/<uuid:pk>', views.EditarLinkCadastroView.as_view(), name="gestao-links-cadastro-editar"),
    path('link-cadastro/<uuid:pk>/remover', views.RemoverLinkCadastroView.as_view(), name="gestao-links-cadastro-remover"),
    path('link-cadastro/<uuid:pk>/ver', views.VerLinkCadastroView.as_view(), name="gestao-links-cadastro-ver"),
