"""
Django settings for sistemada project.
...
SECRET_KEY = 'co1j-&qzj5nnwtvu($lf!po8f$@zdigx2#kib075gt+t^k5enl'
...
ROOT_URLCONF = 'sistemada.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            os.path.join(BASE_DIR, "sistemada", "templates"),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'sistemada.wsgi.application'
